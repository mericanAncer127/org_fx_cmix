...
#include "readalike_prepr/transform.h"
...
int main(int argc, char **argv)
{
  ...
  if (argc == 1)
  {
    ...
    // apply Tag Reversing Transform
    //    std::cout << "Tag Reversing Transform" << std::endl;
    reverseTransformFile();
  ...
  else if (argv[1][1] == 'e')
  {
    ...
    cat(".main_phda9prepr_transformed", ".intro", "un1");
